...
public class QuShotCarouselPicker extends ViewPager {
    ...
    public static class CarouselViewAdapter extends PagerAdapter {
        ...
        public CarouselViewAdapter(Context context2, List<PickerItem> list, int i) {
            ...
            items = list;
            if (drawable == 0) {
                drawable = R.layout.item_carousel;
            }
        }
        ...
        public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
            View inflate = LayoutInflater.from(context).inflate(this.drawable, (ViewGroup) null);
            ImageView imageView = inflate.findViewById(R.id.image_icon);
            View color = inflate.findViewById(R.id.color);
            PickerItem pickerItem = items.get(i);
