package com.photo.collagemaker.activities.scrapbook.quickaction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public void show(View parent, int childX, int childY) {
        ...
        if (anchorWidth < 1) {
            Bitmap arrowBitmap = BitmapFactory.decodeResource(parent.getResources(), R.drawable.ic_arrow_down);
