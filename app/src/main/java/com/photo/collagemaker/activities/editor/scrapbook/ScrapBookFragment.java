package com.photo.collagemaker.activities.editor.scrapbook;
...
import com.photo.collagemaker.activities.editor.scrapbook.adapter.ScrapBGAdapter;
import com.photo.collagemaker.activities.editor.scrapbook.adapter.ScrapStickerAdapter;
import com.photo.collagemaker.activities.editor.scrapbook.interfaces.OnChooseColorListener;
import com.photo.collagemaker.activities.editor.scrapbook.multitouch.controller.ImageEntity;
import com.photo.collagemaker.activities.editor.scrapbook.multitouch.controller.MultiTouchEntity;
import com.photo.collagemaker.activities.editor.scrapbook.multitouch.controller.TextEntity;
import com.photo.collagemaker.activities.editor.scrapbook.multitouch.custom.OnDoubleClickListener;
import com.photo.collagemaker.activities.editor.scrapbook.multitouch.custom.PhotoView;
import com.photo.collagemaker.activities.editor.scrapbook.quickaction.QuickAction;
import com.photo.collagemaker.activities.editor.scrapbook.quickaction.QuickActionItem;
import com.photo.collagemaker.activities.editor.scrapbook.utils.DateTimeUtils;
import com.photo.collagemaker.activities.editor.scrapbook.utils.DialogUtils;
import com.photo.collagemaker.activities.editor.scrapbook.utils.ImageUtils;
import com.photo.collagemaker.activities.editor.scrapbook.utils.PhotoUtils;
import com.photo.collagemaker.activities.editor.scrapbook.utils.ResultContainer;
import com.photo.collagemaker.activities.editor.scrapbook.utils.Utils;
...
public class ScrapBookFragment extends BaseFragment implements
    ...
    private void createQuickAction() {
        QuickActionItem deleteItem = new QuickActionItem(ID_DELETE, "Delete", mActivity.getResources().getDrawable(R.drawable.menu_delete));
        QuickActionItem cancelItem = new QuickActionItem(ID_CANCEL,"Cancel", mActivity.getResources().getDrawable(R.drawable.menu_cancel));
...
//        //by clicking the area outside the dialog.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("PhotoCollageFragment.onCreateView", "onCreateView");
        ...
        mActivity.setTitle("Create freely");


        gallery = rootView.findViewById(R.id.gallery);
        gallery.setOnClickListener(v -> {
            setUnpressBtn(rootView);
            ((ImageView)rootView.findViewById(R.id.tabIV)).setColorFilter(ContextCompat.getColor(getActivity(), R.color.icon_bg_color_theme), android.graphics.PorterDuff.Mode.MULTIPLY);
            ((TextView)rootView.findViewById(R.id.tabTxt)).setTextColor(getActivity().getResources().getColor(R.color.icon_bg_color_theme));
        ...
        sticker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setUnpressBtn(rootView);
                ((ImageView)rootView.findViewById(R.id.tabIV1)).setColorFilter(ContextCompat.getColor(getActivity(), R.color.icon_bg_color_theme), android.graphics.PorterDuff.Mode.MULTIPLY);
                ((TextView)rootView.findViewById(R.id.tabTxt1)).setTextColor(getActivity().getResources().getColor(R.color.icon_bg_color_theme));
        ...
        bgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setUnpressBtn(rootView);
                ((ImageView)rootView.findViewById(R.id.tabIV2)).setColorFilter(ContextCompat.getColor(getActivity(), R.color.icon_bg_color_theme), android.graphics.PorterDuff.Mode.MULTIPLY);
                ((TextView)rootView.findViewById(R.id.tabTxt2)).setTextColor(getActivity().getResources().getColor(R.color.icon_bg_color_theme));
        ...
        textBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setUnpressBtn(rootView);
                ((ImageView)rootView.findViewById(R.id.tabIV3)).setColorFilter(ContextCompat.getColor(getActivity(), R.color.icon_bg_color_theme), android.graphics.PorterDuff.Mode.MULTIPLY);
                ((TextView)rootView.findViewById(R.id.tabTxt3)).setTextColor(getActivity().getResources().getColor(R.color.icon_bg_color_theme));
    ...
    public void onPause() {
        super.onPause();
        Log.d("PhotoCollageFragment.onPause",
    ...
    public void onResume() {
        super.onResume();
        Log.d("PhotoCollageFragment.onResume",
    ...
    public void clickDeleteCurrentPhotoView() {
        ...
        DialogUtils.showConfirmDialog(getActivity(), "Confirm",
                "Are you sure you want to delete this all photos?",
    ...
    public void resultFromPhotoEditor(Uri uri) {
        ...
        Log.d("PhotoCollageFragment.resultFromPhotoEditor", "uri=" + uri.toString());
        if (!already()) {
            return;
        }
    ...
    public void clickShareView() {
        ...
        AsyncTask<Void, Void, File> task = new AsyncTask<Void, Void, File>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                dialog = ProgressDialog.show(mActivity, getString(R.string.app_name),"Creating...");
            }
            ...
            protected void onPostExecute(File file) {
                ...
                dialog.dismiss();
                if (file != null) {
//                    @SuppressLint("StaticFieldLeak") Intent intent = new Intent(getActivity(), ShareActivity.class);
...
//                    startActivity(intent);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        Log.d("PhotoCollageFragment.onDestroyView", "Destroy view");
        mPhotoView.unloadImages();
