...
public class ColorAdapter extends RecyclerView.Adapter<ColorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (selectedColorIndex == i) {
            viewHolder.binding.imageViewSquare.setBackground(context.getDrawable(R.drawable.border_view));
        } else {
            viewHolder.binding.imageViewSquare.setBackground(context.getDrawable(R.drawable.border_transparent_view));
        }
    }
