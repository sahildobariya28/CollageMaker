...
public class FreeStyleViewModel extends ViewModel {
    ...
    public FreeStyleViewModel(Activity activity, ActivityFreeStyleBinding binding) {
    ...
    public void hideAllView() {
        ...
        binding.recyclerBorderColor.setVisibility(View.GONE);
    ...
    public void borderShow() {
        ...
        binding.recyclerBorderColor.setVisibility(View.VISIBLE);
    }
    ...
    public BitmapDrawable addWhiteBorder(Resources res, Bitmap bmp, int borderSize, int color) {
        Bitmap bmpWithBorder = Bitmap.createBitmap(bmp.getWidth() + borderSize * 2, bmp.getHeight() + borderSize * 2, bmp.getConfig());
        Canvas canvas = new Canvas(bmpWithBorder);
        canvas.drawColor(color);
        canvas.drawBitmap(bmp, borderSize, borderSize, null);
        return new BitmapDrawable(res, bmpWithBorder);
    }
