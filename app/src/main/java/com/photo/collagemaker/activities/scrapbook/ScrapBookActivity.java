...
import com.photo.collagemaker.activities.scrapbook.interfaces.OnShareImageListener;

import java.util.List;


public class ScrapBookActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new ScrapBookFragment(imageList);
    ...
    public void onBackPressed() {
        Fragment fragment = (BaseFragment) getVisibleFragment();
