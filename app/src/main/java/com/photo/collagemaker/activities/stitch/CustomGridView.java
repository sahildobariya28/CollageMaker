...
import com.photo.collagemaker.utils.MatrixUtils;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                Log.d(TAG, "sdfasdfwerwe  onTouchEvent: action down" );
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                // Handle the case when a new pointer (finger) goes down
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "sdfasdfwerwe   onTouchEvent: action move" );
            ...
            case MotionEvent.ACTION_CANCEL:
                // Handle the touch up or pointer up event
