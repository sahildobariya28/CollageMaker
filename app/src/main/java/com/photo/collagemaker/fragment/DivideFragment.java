...
import com.photo.collagemaker.adapters.DivideAdapter;
...
public class DivideFragment extends DialogFragment implements DivideListener {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        binding.recyclerViewFilterAll.setAdapter(new DivideAdapter(lstFilterBitmap, this, getContext(), Arrays.asList(EffectCodeAsset.DIVIDE_EFFECTS)));
        binding.imageViewPreview.setImageBitmap(bitmap);
        binding.textViewTitle.setText("Divide");
        binding.imageViewSaveFilter.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                onFilterSavePhoto.onSaveFilter(((BitmapDrawable) binding.imageViewPreview.getDrawable()).getBitmap());
                dismiss();
            }
        });
        binding.imageViewCloseFilter.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                dismiss();
            }
        });
