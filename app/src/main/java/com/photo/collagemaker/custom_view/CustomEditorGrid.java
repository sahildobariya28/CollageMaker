...
public class CustomEditorGrid implements BrushColorChangeListener {
    ...
    private CustomEditorGrid(Builder builder) {
...
//        });
    ...
    public static class Builder {
        ...
        public CustomEditorGrid build() {
            return new CustomEditorGrid(this);
        }
    }
