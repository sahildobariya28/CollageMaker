...
public class FrameAdapter extends RecyclerView.Adapter<FrameAdapter.ViewHolder> {
    ...
    public FrameAdapter(Context context, FrameListener frameListener) {
        ...
        squareViewList.add(new SquareView(R.drawable.gradient_0, "None"));
        ...
        for (int i = 0; i < lstcolorforbrush.size() - 2; i++) {
            squareViewList.add(new SquareView(Color.parseColor(lstcolorforbrush.get(i)), "", true));
        }
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            frameListener.onBackgroundSelected(squareViewList.get(selectedSquareIndex));
